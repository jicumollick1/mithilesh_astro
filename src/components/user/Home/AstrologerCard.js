...
const AstrologerCard = ({data}) => {
    const {name, image, type, rating, price, reviews, experience, speciality, language, status} = data;
    return(
        <View style={styles.card}>
            ...
            <View style={{flexDirection: 'row', gap: responsiveWidth(3)}}>
                ...
                <View style={{justifyContent: 'space-between'}}>
                    <Text style={{color: Colors.black, fontSize: responsiveFontSize(2.2), fontWeight: 'bold'}} >{name}</Text>
                    <Text style={{color: Colors.black, fontSize: responsiveFontSize(2), fontWeight: 500}} >{type}</Text>
            ...
            <View style={{gap: responsiveWidth(3)}}>
                <View style={{flexDirection: 'row', gap: responsiveWidth(2), alignItems: 'center'}}>
                    <EvilIconsIcons name="star" size={responsiveWidth(5)} color={Colors.black} />
                ...
                <View style={{flexDirection: 'row', gap: responsiveWidth(4), alignItems: 'center'}}>
                    <Image source={Icons.language} style={{height: responsiveWidth(4), width: responsiveWidth(4), resizeMode: 'contain'}} />
                    <Text style={{color: Colors.black, fontSize: responsiveFontSize(1.5), fontWeight: 500}} >{language}</Text>
                </View>
                <View style={{flexDirection: 'row', gap: responsiveWidth(3)}}>
                    <Button title="Chat" buttonStyle={styles.btn} icon={<FeatherIcons name="phone-call" size={responsiveWidth(4)} color={Colors.white} />} />
                    <Button title="Call" buttonStyle={styles.btn} icon={<MaterialIcons name="chat-bubble-outline" size={responsiveWidth(4)} color={Colors.white} />} />
                </View>
            </View>
        </View>
    );
