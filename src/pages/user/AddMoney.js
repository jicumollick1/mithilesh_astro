...
const AddMoney = ({navigation, route}) => {
  return (
    <UserView>
      <TopNavigator navigation={navigation} title="Add Money" />
      <ScrollView>
        <View style={{marginLeft: width * 0.05}}>
          <View style={styles.yellowBox}>
            ...
            <Image
              ...
              style={{width: 150, height: 90, marginVertical: 20}}
            />
            <Text
              style={{
                fontWeight: 500,
              ...
              Add money to your wallet before making a call to the astrologer
            </Text>
          </View>
        </View>
