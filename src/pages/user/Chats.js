      ...
      <View
        style={[
          WhiteContainerStyles.container,
          {
            ...
            paddingVertical: responsiveWidth(0),
            ...
            <View
              ...
              <View style={{gap: responsiveWidth(3)}}>
                ...
                <LeftChat
                  ...
                  message={'Hello Guruji! Namaste'}
                  time={'3.00pm'}
                />
                <RightChat
                  message={
                    'Thanks , You will have a bright future and blessed with guru'
                  }
                  time={'3.00pm'}
                />
              </View>
    ...
    <View
      ...
      <View style={{alignItems: 'flex-end'}}>
        <View
          ...
          <Text style={{color: Colors.white, fontFamily: Fonts.ubuntuRegular}}>
            {message}
          </Text>
          <Ionicons
            name={'checkmark-done'}
        ...
        <Text style={{color: '#000', fontSize: responsiveFontSize(1.5)}}>
          {time}
        </Text>
      </View>
    </View>
