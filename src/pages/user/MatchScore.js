...
const MatchScore = ({navigation}) => {
    return (
        <UserView>
            <TopNavigator title={'Match Score'} />
            <ScrollView>
                <View style={{paddingHorizontal: responsiveWidth(5), marginVertical: responsiveWidth(5), gap: responsiveWidth(5)}}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', backgroundColor: Colors.Yellow, padding: responsiveWidth(2), borderRadius: responsiveWidth(2)}}>
                        <Image source={Images.IndianWedding} style={styles.avatar} />
                        <View style={{justifyContent: 'space-between'}}>
                            <View style={{flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-end'}}>
                                <View style={{backgroundColor: Colors.darkBlue2, paddingHorizontal: responsiveWidth(4), paddingVertical: responsiveWidth(2.5), borderRadius: responsiveWidth(50)}}>
                ...
                <View style={[WhiteContainerStyles.container, {paddingHorizontal: responsiveWidth(2), paddingVertical: responsiveWidth(2), gap: responsiveWidth(5)}]}>
                    ...
                    <View style={{gap: responsiveWidth(3)}}>
                        ...
                        <View style={{borderColor: Colors.darkBlue2, borderWidth: responsiveWidth(0.3), borderRadius: responsiveWidth(1), padding: responsiveWidth(3), gap: responsiveWidth(3)}}>
...
const BulletPoint = ({text}) => {
    return(
        <View style={{flexDirection: 'row', gap: responsiveWidth(3), alignItems: 'flex-start'}}>
            <View style={{width: responsiveWidth(2), height: responsiveWidth(2), borderRadius: responsiveWidth(50), backgroundColor: Colors.darkBlue2, marginTop: responsiveWidth(2)}} />
            <Text style={{color: Colors.black, fontSize: responsiveFontSize(2)}}>{text}</Text>
        </View>
    );
};
