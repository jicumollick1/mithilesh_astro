...
const Phone = ({navigation}) => {
    ...
    return (
        <UserView>
            <Text style={{fontWeight: 'bold', fontSize: responsiveFontSize(3), color: Colors.white, padding: responsiveWidth(5), textAlign: 'center'}}>Live Chats & Calls</Text>
            <View style={{flex: 1, gap: responsiveWidth(5)}}>
                <View style={{paddingHorizontal: responsiveWidth(5), gap: responsiveWidth(3)}}>
                    <View style={styles.searchContainer}>
                        <FeatherIcons name="search" size={20} color={Colors.black} />
                        <TextInput placeholder="Search Messages..." placeholderTextColor={Colors.black} style={{flex: 1}} value={searchText} onChangeText={setSearchText} />
                    </View>
                ...
                <View style={[WhiteContainerStyles.container, {gap: responsiveWidth(3)}]}>
                    <View style={{flexDirection: 'row', gap: responsiveWidth(5)}}>
                        <Button title={"Live Chats"} buttonStyle={{backgroundColor: Colors.white, padding: 0}} titleStyle={{color: selected==='Live chats'?Colors.black:'rgba(37, 38, 43, 0.75)', fontWeight: 'bold', fontSize: responsiveFontSize(2), borderBottomColor: selected==='Live chats'?Colors.darkBlue2:Colors.white, borderBottomWidth: responsiveWidth(1)}} onPress={()=> setSelected('Live chats')} />
                        <Button title={"Audio Call"} buttonStyle={{backgroundColor: Colors.white, padding: 0}} titleStyle={{color: selected==='Audio Call'?Colors.black:'rgba(37, 38, 43, 0.75)', fontWeight: 'bold', fontSize: responsiveFontSize(2), borderBottomColor: selected==='Audio Call'?Colors.darkBlue2:Colors.white, borderBottomWidth: responsiveWidth(1)}} onPress={()=> setSelected('Audio Call')} />
                    </View>
                    <ScrollView>
                        {
        ...
        <TouchableOpacity style={{flexDirection: 'row', alignItems: 'center', gap: responsiveWidth(3), borderBottomColor: Colors.darkBlue2, borderBottomWidth: responsiveWidth(0.1), paddingVertical: responsiveWidth(3)}} onPress={onClick} >
            ...
            <View style={{flex: 1, gap: responsiveWidth(1)}}>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center', gap: responsiveWidth(1)}}>
                    <Ionicons name={'checkmark-done'} size={responsiveFontSize(2)} color={Colors.darkBlue2} />
