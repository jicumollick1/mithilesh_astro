            ...
            <View style={styles.blurBackground}>
                <View style={{flexDirection: 'row', gap: responsiveWidth(5), justifyContent: 'space-between', alignItems: 'center'}}>
                    ...
                    <View style={{alignItems: 'center'}}>
                        <Image source={Icons.vForwardArrow} style={{
                ...
                <View style={{backgroundColor: 'white', paddingVertical: responsiveWidth(5), paddingHorizontal: responsiveWidth(15), borderRadius: responsiveWidth(7), gap: responsiveWidth(1)}}>
                    <Text style={{color: Colors.black, fontSize: responsiveFontSize(2.5), fontWeight: 'bold'}}>Time Remaining</Text>
                ...
                <View style={{flexDirection: 'row', alignItems: 'center', gap: responsiveWidth(10)}}>
                    <TouchableOpacity style={{gap: responsiveWidth(2), alignItems: 'center'}}>
                        <View style={{backgroundColor: 'rgba(255, 222, 72, 0.2)', borderRadius: responsiveWidth(50), padding: responsiveWidth(3)}}>
